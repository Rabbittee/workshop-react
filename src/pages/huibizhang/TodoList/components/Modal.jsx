...
const Modal = (props) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx([
          'w-10/12 sm:w-full sm:max-w-md md:max-w-xl lg:max-w-2xl overflow-hidden rounded-md bg-white transition-all duration-200 dark:bg-gray-700',
      ...
      >
        ...
        <div className="w-full">
          {props.children ? props.children : <div className="p-3">{content}</div>}
        </div>
      </div>
    </div>
  );
